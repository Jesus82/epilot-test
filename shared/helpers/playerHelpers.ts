/**
 * Shared player helper functions
 * Pure functions for player/bid data transformations - no external dependencies
...
import type { ApiPlayerStats, BidResult } from '../types/api'
